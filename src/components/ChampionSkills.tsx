...
import ChampionSkillsItem from "./ChampionSkillsItem";

import ChampionSpell from "./ChampionSkillsItem";
import ChampionSpellDesc from "./ChampionSkillsItemDesc";
    ...
    <section>
      <div className="champion__page__skills">
        ...
        <button onClick={linkAbilityToDescription} id="3" className="champion__page__skills__button">
          <ChampionSpell img={champion.ChampionAbility3_URL} control="A" />
        </button>
        <button onClick={linkAbilityToDescription} id="4" className="champion__page__skills__button">
          <ChampionSpell img={champion.ChampionAbility4_URL} control="F" />
        </button>
        <button onClick={linkAbilityToDescription} id="5" className="champion__page__skills__button">
          <ChampionSpell img={champion.ChampionAbility5_URL} control="E" />
        </button>
      </div>
      <div className="champion__page__skills__container">
        <ChampionSpellDesc ability={activeSpell} img={activeSpellImg} />
      </div>
    </section>
  );
}
